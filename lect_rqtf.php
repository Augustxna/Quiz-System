...
<html>
<head>
    <title>View Result Quiz True False</title>
    <meta charset="utf-8">
        ...
        <table width="100%" border="1" style="border-collapse:collapse;">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td><h3>Result Quiz True / False</h3></td>
                </tr>
            ...
            if (isset($_REQUEST['wid'])) {
                ...
                $bq = "SELECT student_registration.sr_id AS srid, student_registration.student_id AS sid, student.student_name AS sn, student_registration.qtf_mark AS qm FROM student_registration JOIN student ON student.student_id = student_registration.student_id WHERE student_registration.wl_id = $wid";
